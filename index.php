...
<body class="h-vh-100 bg-brandColor2">
    ...
    <a class="button primary cell-4  offset-4 drop-shadow" href="tambahmahasiswa.php"><span class="mif-plus"></span> Tambah Data Mahasiswa</a>
    <br><br>
    ...
    <tbody>
        ...
        <tr class="row-hover">
            <td><?php echo $i; ?></td>
            <td>
                <a class="button success drop-shadow" href="ubahmahasiswa.php?id=<?php echo $row["id"]; ?>"><span class="mif-pencil mif-2x"></span> Edit</a>
                <a class="button alert drop-shadow" href="hapusmahasiswa.php?id=<?php echo $row["id"]; ?>" onclick="return confirm('Yakin');"><span class="mif-bin mif-2x"></span>Hapus</a>
            </td>
