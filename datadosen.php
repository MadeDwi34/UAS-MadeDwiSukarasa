...
<body class="h-vh-100 bg-brandColor2">
    <?php include 'nav.php'; ?>
    <br><br><br>
    <h1 align="center" style="color: white;">Daftar Dosen</h1>
    <a class="button primary cell-4  offset-4 drop-shadow" href="tambahdosen.php"><span class="mif-plus"></span> Tambah Data Dosen</a>
    <br><br>
    
    <form action="" method="post">
    <div class="form-group cell-6  offset-3">
        <input type="text"  name="keyword" placeholder="Cari dengan nama atau nip" autofocus autocomplete="off">
    ...
    <tbody>
        ...
        <tr class="row-hover">
            <td><?php echo $i; ?></td>
            <td>
                <a class="button success drop-shadow" href="ubahdosen.php?id=<?php echo $row["id"]; ?>"><span class="mif-pencil mif-2x"></span> Edit</a>
                <a class="button alert drop-shadow" href="hapusdosen.php?id=<?php echo $row["id"]; ?>" onclick="return confirm('Yakin');"><span class="mif-bin mif-2x"></span>Hapus</a>
            </td>
