...
<body class="h-vh-100 bg-brandColor2">
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group cell-6  offset-3">
            ...
            <input type="text" id="Agama" name="Agama" placeholder="Agama" required value="<?php echo $mhs["Agama"]; ?>">
        </div>
        ...
        <div class="form-group cell-6  offset-3">
            ...
            <input type="text" id="Fakultas" name="Fakultas" placeholder="Fakultas" required value="<?php echo $mhs["Fakultas"]; ?>">
        </div>
